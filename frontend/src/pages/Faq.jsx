...
const Faq = () => {
    ...
    return (
        <div className=" flex justify-center items-center  bg-gray-50 dark:bg-gray-900 p-2">
            ...
            <div className="relative w-full  h-[80vh] rounded-2xl shadow-xl overflow-hidden bg-white dark:bg-gray-800">
                ...
                <section className="relative bg-white rounded-xl shadow p-2 mx-auto max-w-4xl mt-8 items-center dark:bg-gray-800 border border-gray-300">
                ...
                <section className="relative bg-white/100 rounded-xl shadow p-2 max-w-4xl  mx-auto mt-4 dark:bg-gray-800 border border-gray-300 ">
                    <div className="space-y-8">
                        {faqs.map((faq, index) => (
                            <div key={index} className="border border-gray-200 rounded-xl dark:border-gray-700">
                                <button
                                    onClick={() => toggle(index)}
                                    className="flex items-center justify-between w-full p-6 text-s font-small text-left text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800"
                                >
                                    <span>{faq.question}</span>
                                    <svg
                                        className={`w-2 h-4 transform transition-transform duration-200 ${openIndex === index ? 'rotate-180' : ''}`}
                                        fill="none"
                                        stroke="currentColor"
                                        strokeWidth="2"
                                        strokeLinecap="round"
                                ...
                                {openIndex === index && (
                                    <div className="p-2 text-gray-500 text-small dark:text-gray-400 bg-white dark:bg-gray-900">
                                        {faq.answer}
                                    </div>
                                )}
                            </div>
