      ...
      >
        ...
        <div className="flex justify-between mb-10 pr-3 sm:px-2">
          ...
          <NavLink end to="/" className="block">
            <img className="h-14 w-17" src={Atomic} alt="Atomic"/>
          </NavLink>
        </div>
              ...
              <li className={`pl-4 pr-3 py-2 rounded-lg mb-0.5 last:mb-0 bg-linear-to-r ${pathname.includes("calendar") && "from-violet-500/[0.12] dark:from-violet-500/[0.24] to-violet-500/[0.04]"}`}>
                ...
                >
                  <div className="flex items-center">
                    ...
                    <span className="text-sm font-medium ml-4 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Diario</span>
                  </div>
                </NavLink>
              </li>
