...
export default function LoginForm(){
    ...
    return(
        <>
        <div className="flex flex-1 flex-col justify-center min-h-full px-6 py-3 lg:px-8">
            <div className="bg-opacity-20 mt-0 sm:mx-auto sm:w-full sm:max-w-sm">
            <img
              alt="Atomic"
          ...
          <div className="bg-sky-800 rounded-md p-8 shadow-lg backdrop-filter backdrop-blur-sm bg-opacity-20 mt-4 sm:mx-auto sm:w-full sm:max-w-sm">
            <div className="sm:mx-auto sm:w-full sm:max-w-sm ">
                ...
                <div>
                  ...
                  <div className="mt-2">
                    <input
                      ...
                      required
                      autoComplete="email"
                      className="block border-2 border-sky-200 w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 outline-offset-1 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6"
                    />
                  </div>
                </div>
              ...
              <p className="mt-5 text-center text-sm/6 text-inherit">
                ...
                <a href="#" className="font-semibold text-indigo-800 hover:text-indigo-400">
                  ¡Regístrate Ahora!
                </a>
              </p>
