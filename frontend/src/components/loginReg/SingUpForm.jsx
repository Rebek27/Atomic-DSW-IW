...
export default function SignUpForm() {
  return (
    <>
      <div className="relative flex min-h-screen flex-1 flex-col justify-center px-6 py-3 lg:px-8">
        <div className="bg-white rounded-xl p-5 shadow-lg backdrop-filter backdrop-blur-sm bg-opacity-90 mt-1 sm:mx-auto sm:w-full sm:max-w-lg">
